...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  addModel('./assets/model.glb', [0, 0.2, 0]);        // 正中
  addModel('./assets/model.glb', [0.3, 0.2, 0], 0.4); // 右侧略小
  addModel('./assets/model.glb', [-0.3, 0.2, 0], 0.6);// 左侧略大
  addModel('./assets/model.glb', [0, 0.2, -0.3], 0.5, Math.PI / 4); // 背后稍微转个角度
