...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  addModel('./assets/models/model.glb', [-0.3, -1.4, 0.2], 0.1);       
  addModel('./assets/models/model.glb', [0.2, -1.05, 0.2], 0.1); 
  addModel('./assets/models/model.glb', [-0.15, -0.15, 0.2], 0.1);
  addModel('./assets/models/model.glb', [0.1, 0.5, 0.2], 0.1); 
  addModel('./assets/models/model.glb', [-0.3, 1, 0.2], 0.1); 
  addModel('./assets/models/model.glb', [0.3, 1.4, 0.2], 0.1); 
  // 点击进入全屏（只触发一次）
